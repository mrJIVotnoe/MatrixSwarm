...
import { Database, Upload, FileText, Server } from 'lucide-react';
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 max-h-[150px] overflow-y-auto custom-scrollbar pr-2">
          {records.length === 0 ? (
            ...
            records.map(record => (
              <div key={record.id} className="p-2 border border-purple-900/30 bg-purple-900/5 flex justify-between items-center">
